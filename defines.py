...
class EventsFirst(enum.Enum):
    ...
    # MM
    MM_MEETING_WITH_SPOUSE = 1
    MM_MEETING_WITH_SPOUSE_INITIAL = 2
    MM_MEETING_WITH_VASSAL = 3
    MM_MEETING_WITH_VASSAL_INITIAL = 4
    MM_MEETING_WITH_LIEGE = 5
    MM_MEETING_WITH_LIEGE_INITIAL = 6
    MM_MEETING_WITH_PRISONER = 7
    MM_MEETING_WITH_PRISONER_INITIAL = 8
    MM_MEETING_WITH_ACQUAINTANCE = 9
    MM_MEETING_WITH_ACQUAINTANCE_INITIAL = 10
...
class EventsSex(enum.Enum):
    ...
    MM_HANDJOB = 7
    MM_BLOWJOB_DOM = 8
    MM_STANDING_FUCKED_FROM_BEHIND = 9
    MM_BLOWJOB_SUB = 10
    MM_DEEPTHROAT = 11
    MM_HOTDOG = 12
    MM_STANDING_FINGERED_FROM_BEHIND = 13
    MM_ASS_RUB = 14
    MM_REVERSE_COWGIRL = 15
    MM_COWGIRL = 16
    MM_MISSIONARY = 17
    MM_PRONE_BONE = 18
...
class EventsCum(enum.Enum):
    ...
    MM_HANDJOB_CUM_IN_HAND = 1
    MM_BLOWJOB_CUM_IN_MOUTH_DOM = 2
    MM_BLOWJOB_CUM_IN_MOUTH_SUB = 3
    MM_BLOWJOB_CUM_ON_FACE = 4
    MM_RUINED_ORGASM = 5
    MM_ASS_TEASE_CUM_ON_ASS = 6
    MM_CUM_ON_GROIN = 7
    MM_PULL_OUT_CUM_ON_ASS = 8
    MM_CREAMPIE_BREED = 11
    MM_CREAMPIE_KEEP = 12
    MM_CUM_ON_FOOT = 24
